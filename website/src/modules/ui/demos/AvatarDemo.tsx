  ...
  return (
    <DemoExample
      preview={() => (
        <div className={'flex flex-row items-center gap-3'}>
          <Avatar name={'Alexander Hipp'} src={'https://nxt.resolid.tech/images/a001.jpg'}>
            <AvatarBadge className={'h-5 w-5 border-3 border-bg-subtle bg-bg-success-emphasis'} />
          </Avatar>
          <Avatar name={'Alex Suprun'} src={''}>
            <AvatarBadge className={'h-5 w-5 border-3 border-bg-subtle bg-bg-warning-emphasis'} />
          </Avatar>
          <Avatar src={'https://nxt.resolid.tech/images/a004.jpg'}>
            <AvatarBadge className={'h-5 w-5 border-3 border-bg-subtle bg-bg-danger-emphasis'} />
          </Avatar>
          <Avatar src={''}>
            <AvatarBadge className={'h-5 w-5 border-3 border-bg-subtle bg-bg-primary-emphasis'} />
          </Avatar>
        </div>
      )}
      snippet={`<div className={'flex flex-row gap-3 items-center'}>

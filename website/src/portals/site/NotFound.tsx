    ...
    <Layout>
      ...
      <div className={cx('mx-auto h-full max-w-3xl p-4', className)}>
        <div className={'relative mt-16 w-full'}>
          ...
          <div className={'relative z-[1] mx-auto flex max-w-xl flex-col justify-center pt-32 text-center'}>
            <h1 className={'mb-3 text-xl font-bold'}>{t('error.404.message')}</h1>
            <p className={'mt-5'}>{t('error.404.content')}</p>
            <div className={'mt-6'}>
              <BackButton />
            </div>
          </div>
